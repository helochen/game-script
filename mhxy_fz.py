...
if __name__ == "__main__":
    ...
    # result = reader.readtext(u'G:\\1.map\\task\\t2.jpg')
    # print(result)
    screen_resolution = resolution()
    ...
    print(window_size)
    topx, topy = window_size[0], window_size[1]
    img_qinglong_task = ImageGrab.grab((800, 205, 1000, 250))
    # TODO 根据图片任务信息
    # result = reader.readtext(img_qinglong_task)
    # print(result)
    # 点击人物
    mouseClick(rect, hwnd)
    global is_start
    # 创建主窗口
    root = tk.Tk()
    root.title("梦幻西游手游辅助")
    ...
    # 创建按钮
    # qinglongButton = tk.Button(root, text=u"青龙任务,人物需要在青龙室", command= lambda: MyThread(shimen, window_size),width=30,height=4);
